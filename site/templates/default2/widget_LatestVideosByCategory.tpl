  <style>
    ...
    .tab a { background: url("templates/default2/tmp/images/cathead-m.gif") repeat-x left top; /*font-size: 14px;*/ line-height: 2em; display: block; padding: 0 5px; outline: none; color: white;}
