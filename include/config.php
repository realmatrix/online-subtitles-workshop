<?php
	...
	$GLOBALS['config']['widgets'] = "widget_shoutbox,widget_ImageGallery,widget_login,widget_UserInfo,widget_NewsLetter,"; //example "widget_example1,widget_example2,widget_example3"
