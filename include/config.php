<?php
	...
	$GLOBALS['config']['widgets'] = "widget_shoutbox,widget_login,widget_UserInfo,widget_NewsLetter,widget_QuickLinks,widget_Manage,widget_VideoGallery,widget_ThumbnailsGallery"; //example "widget_example1,widget_example2,widget_example3"
